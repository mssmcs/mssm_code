...
option(MSSM_ENABLE_SANITIZERS "Enable sanitizers for Debug/RelWithDebInfo builds" OFF)
if (MSSM_ENABLE_SANITIZERS)
  if (MSVC)
    message(WARNING "MSSM_ENABLE_SANITIZERS is ON, but this repo currently configures sanitizers only for GCC/Clang.")
  elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang|GNU")
    if (CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
      message(WARNING "MSSM_ENABLE_SANITIZERS is ON, but Windows MinGW toolchains often do not ship libasan. Skipping sanitizer flags.")
      set(MSSM_SANITIZER_FLAGS "")
    else ()
      set(MSSM_SANITIZER_FLAGS "-fsanitize=address,undefined" "-fno-omit-frame-pointer")
    endif ()

    foreach (_flag IN LISTS MSSM_SANITIZER_FLAGS)
      add_compile_options($<$<OR:$<CONFIG:Debug>,$<CONFIG:RelWithDebInfo>>:${_flag}>)
      add_link_options($<$<OR:$<CONFIG:Debug>,$<CONFIG:RelWithDebInfo>>:${_flag}>)
    endforeach ()
  else ()
    message(WARNING "MSSM_ENABLE_SANITIZERS is ON, but compiler '${CMAKE_CXX_COMPILER_ID}' is not configured for sanitizers.")
  endif ()
endif ()
